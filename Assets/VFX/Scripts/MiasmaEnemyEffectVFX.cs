...
public class MiasmaEnemyEffectVFX : MonoBehaviour
{
    ...
    public void LoadDefaultAssets()
    {
        ...
        if (skullMaterial == null)
            skullMaterial = UnityEditor.AssetDatabase.LoadAssetAtPath<Material>("Assets/VFX/Materials/MiasmaSpectralSkullMat.mat");
    ...
    private void ConfigureWaistRing(ParticleSystem ps)
    {
        ...
        main.startSize = new ParticleSystem.MinMaxCurve(0.40f, 0.70f);
        ...
        vol.space = ParticleSystemSimulationSpace.Local;
        vol.y = 0.05f;
        vol.orbitalY = swirlSpeed * Mathf.Deg2Rad * 1.5f; // Fast orbiting ring
        ...
        g.SetKeys(
            new GradientColorKey[] {
                new GradientColorKey(boneWhiteColor, 0.0f),
                new GradientColorKey(spectralTint, 0.4f),
                new GradientColorKey(lavenderColor, 1.0f)
            },
            new GradientAlphaKey[] {
                new GradientAlphaKey(0.0f, 0.0f),
                new GradientAlphaKey(0.70f, 0.20f),
