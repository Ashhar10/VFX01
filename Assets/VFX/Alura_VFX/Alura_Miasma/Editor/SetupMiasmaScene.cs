...
public static class SetupMiasmaScene
{
    ...
    public static void ExecuteSetup()
    {
        ...
        if (smokeGO != null)
        {
            ...
            Material plumeMat = AssetDatabase.LoadAssetAtPath<Material>("Assets/VFX/Alura_VFX/Alura_Miasma/Materials/NecromanticSmokeMat.mat");
            Material wispMat = AssetDatabase.LoadAssetAtPath<Material>("Assets/VFX/Alura_VFX/Alura_Miasma/Materials/NecromanticWispMat.mat");
            Material orbMat = AssetDatabase.LoadAssetAtPath<Material>("Assets/VFX/Alura_VFX/Alura_Miasma/Materials/MiasmaSoulOrbMat.mat");
            Material diamondMat = AssetDatabase.LoadAssetAtPath<Material>("Assets/VFX/Alura_VFX/Alura_Miasma/Materials/MiasmaSparkleDiamondMat.mat");
            Material crossMat = AssetDatabase.LoadAssetAtPath<Material>("Assets/VFX/Alura_VFX/Alura_Miasma/Materials/MiasmaSparkleCrossMat.mat");
    ...
    public static void ExecuteAffectedEnemySetup()
    {
        ...
        Material skullMat = AssetDatabase.LoadAssetAtPath<Material>("Assets/VFX/Alura_VFX/Alura_Miasma/Materials/MiasmaSpectralSkullMat.mat");
        Material plumeMat = AssetDatabase.LoadAssetAtPath<Material>("Assets/VFX/Alura_VFX/Alura_Miasma/Materials/NecromanticSmokeMat.mat");
        Material wispMat = AssetDatabase.LoadAssetAtPath<Material>("Assets/VFX/Alura_VFX/Alura_Miasma/Materials/NecromanticWispMat.mat");
        Material diamondMat = AssetDatabase.LoadAssetAtPath<Material>("Assets/VFX/Alura_VFX/Alura_Miasma/Materials/MiasmaSparkleDiamondMat.mat");
        Material crossMat = AssetDatabase.LoadAssetAtPath<Material>("Assets/VFX/Alura_VFX/Alura_Miasma/Materials/MiasmaSparkleCrossMat.mat");
